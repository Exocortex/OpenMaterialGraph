...
var getPhysicalPropertiesFromBRDFVRayMtl = function( node ) {
  ...
  properties['translucencyMap'] = getImageFromInput( node.inputs['translucency_color'], false );
  if( properties['translucencyMap'] ) {
    properties['translucencyColor'] = { r:1, g:1, b:1 };
  }
  else {
    properties['translucencyColor'] = getColorFromInput( node.inputs['translucency_color'], false );
  }
