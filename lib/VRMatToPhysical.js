...
var getPhysicalPropertiesFromBRDFVRayMtl = function( node ) {
  ...
  var reflectColor = getColorFromInput(node.inputs['reflect'], true);
  var baseColor    = properties['baseColor'];
  var reflectIntensity = null;
  if (reflectColor) {
  ...
  // adjust the base color (if it's set)
  if (reflectIntensity && !properties['baseMap']) {
    baseColor.r += (reflectColor.r - baseColor.r)*reflectIntensity;
    baseColor.g += (reflectColor.g - baseColor.g)*reflectIntensity;
    baseColor.b += (reflectColor.b - baseColor.b)*reflectIntensity;
  }
