...
var getPhysicalPropertiesFromBRDFVRayMtl = function( node ) {
  ...
  properties['roughness'] = clampColor(getColorFromInput( node.inputs['reflect_glossiness'], false )).r;
  ...
  properties['metallic'] = fresnel;   // because 1.0 for metallic is too much
  ...
  if (!properties['baseMap']) {
    ...
    baseColor.r += (1.0 - baseColor.r)*fresnel;
    baseColor.g += (1.0 - baseColor.g)*fresnel;
    baseColor.b += (1.0 - baseColor.b)*fresnel;
    // var epsilonColor = 1.0/255.0;           // because full metallic, it should reflect something
    // baseColor.r -= fresnel*(baseColor.r - epsilonColor);
    // baseColor.g -= fresnel*(baseColor.g - epsilonColor);
    // baseColor.b -= fresnel*(baseColor.b - epsilonColor);
  }
