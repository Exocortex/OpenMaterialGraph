...
var pluginNameToStructure = {};

var sanitizeTypeValue = function( name, type, value ) {
			...
			for( var m = 0; m < vrayplugins.length; m ++ ) {
				...
				if( vrayPlugin ) {
					...
					for( var j = 0; j < params.length; j ++ ) {
						...
						var paramResult = sanitizeTypeValue( paramName, paramType, param.value );

						data.inputs[ paramResult.name ] = {
							type: paramResult.type,
					...
					console.log();
					pluginNameToStructure[ nodeName ] = data;
				}
			}
		}
	}
